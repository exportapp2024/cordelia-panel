    ...
    <>
      ...
      >
        ...
        <div className="p-4 sm:p-6 space-y-6 overflow-y-auto flex-1">
          ...
          {/* Status Selection */}
          <div className="border-t border-gray-200 pt-4">
            <p className="text-sm font-medium text-gray-700 mb-3">Durum</p>
        ...
        {canModify && onDelete && (
          <div className="flex items-center justify-end space-x-3 p-4 sm:p-6 border-t border-gray-200 flex-shrink-0 bg-white">
            <button
              ...
              disabled={isDeleting}
              className="px-4 py-2.5 text-sm sm:text-base border border-red-300 rounded-lg text-red-700 hover:bg-red-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center space-x-2"
            >
              {isDeleting ? (
                <>
